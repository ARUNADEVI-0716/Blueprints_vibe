...
// // //
// // // export default function DocumentVerificationPanel({ userId, applicationId }: {
// // //     userId: string
...
// // //             .select('pan_number, aadhaar_number, guarantor_name, guarantor_mobile, guarantor_relation')
// // //             .eq('id', applicationId)
// // //             .single()
// // //         setApplication(app)
// // //         setLoading(false)
// // //     }
// // //
// // //     const handleVerifyDoc = async (docId: string, verified: boolean, reason?: string) => {
// // //         await supabase
// // //             .from('loan_documents')
// // //             .update({
// // //                 verified,
// // //                 verified_by: 'officer@nexus.com',
...
// // //                             <p className="font-mono font-bold text-2xl text-gray-900">{application.pan_number || 'Not provided'}</p>
// // //                         </div>
// // //                         <div className="bg-purple-50 rounded-2xl p-5">
...
// // //                 <div className="bg-white rounded-3xl p-8 border border-purple-100">
// // //                     <h3 className="font-bold text-2xl text-gray-800 mb-6">👥 Guarantor Details</h3>
// // //                     <div className="grid grid-cols-3 gap-6">
// // //                         <div className="bg-purple-50 rounded-2xl p-5">
// // //                             <p className="text-sm text-gray-400 uppercase tracking-wide font-semibold mb-2">Name</p>
// // //                             <p className="font-bold text-xl text-gray-900">{application.guarantor_name}</p>
// // //                         </div>
// // //                         <div className="bg-purple-50 rounded-2xl p-5">
// // //                             <p className="text-sm text-gray-400 uppercase tracking-wide font-semibold mb-2">Mobile</p>
// // //                             <p className="font-bold text-xl text-gray-900">{application.guarantor_mobile}</p>
// // //                         </div>
// // //                         <div className="bg-purple-50 rounded-2xl p-5">
// // //                             <p className="text-sm text-gray-400 uppercase tracking-wide font-semibold mb-2">Relation</p>
// // //                             <p className="font-bold text-xl text-gray-900">{application.guarantor_relation || 'Not specified'}</p>
// // //                         </div>
// // //                     </div>
// // //                 </div>
// // //             )}
...
// // //                                     </p>
// // //                                     <p className="text-gray-400 text-sm mt-1">{doc.file_name}</p>
// // //                                     {doc.verified && (
...
// // //                                                     if (reason) handleVerifyDoc(doc.id, false, reason)
// // //                                                 }}
// // //                                                 className="px-4 py-2 bg-red-100 text-red-600 rounded-xl text-sm font-semibold hover:bg-red-200 transition-colors">
// // //                                                 ❌ Reject
// // //                                             </button>
// // //                                         </>
// // //                                     )}
