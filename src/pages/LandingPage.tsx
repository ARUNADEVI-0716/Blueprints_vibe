...
//                         <Link to="/get-started"
//                               className="text-xl bg-purple-600 hover:bg-purple-700 text-white font-semibold px-8 py-3.5 rounded-2xl transition-colors"
...
//                     Nexus uses real data and AI to deliver instant, fair loan
...
//                     <Link to="/get-started"
//                           className="bg-purple-600 hover:bg-purple-700 text-white font-bold text-xl px-14 py-5 rounded-2xl transition-all duration-200 hover:shadow-xl hover:shadow-purple-200">
//                         Apply for a Loan
//                     </Link>
//                     <Link to="/get-started"
//                           className="bg-white hover:bg-purple-50 text-purple-700 font-bold text-xl px-14 py-5 rounded-2xl border border-purple-200 transition-all duration-200">
//                         How it works ↓
//                     </Link>
//                 </div>
//             </main>
...
//                     {[
//                         { icon: '🏦', title: 'Bank-grade security', desc: '256-bit TLS encryption, fully secure and compliant' },
//                         { icon: '⚡', title: 'Real-time decisions', desc: 'Average loan decision in under 8 seconds' },
//                         { icon: '🎯', title: 'Fair AI scoring', desc: 'Transparent, explainable credit decisions' },
//                     ].map((f) => (
//                         <div key={f.title}
//                              className="bg-white border border-purple-100 rounded-3xl p-10 flex items-start gap-6 hover:border-purple-300 transition-all duration-200 hover:shadow-xl hover:shadow-purple-50">
